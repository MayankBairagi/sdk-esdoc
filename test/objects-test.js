...
describe('Object test cases', function() {

    //Test cases for pricing object

    it('for flight object', function() {
    ...
    it('for passengerCount object', function() {
        var passCountObj = dataObjects.passengerCounts(1, 2, 1, 0, 0);

        var passCountTestObj = {
            adult: 1,
            child: 2,
            infantInLap: 1,
            infantInSeat: 0,
    ...
    it('for segment object', function() {
        var dataObj = {
            key1: 'key1',
            key2: 'kek2'
        };
    ...
    //Test cases for Purchase objects

    it('for DateOfBirth object', function() {
    ...
    it('for tripData object', function() {
        var DOBObj = dataObjects.dateOfBirth(2016, 1, 28);
    ...
    it('for PurchaseData object', function() {
        var dataObj = {
            key1: 'key1',
            key2: 'kek2'
        };
